...
public class RiakcsServiceInfoCreatorTest {
    ...
    public void riakcsServicesAreAvailableThroughServiceInfo() throws IOException {
        ...
        assertThat(serviceInfo.getUri(), is("https://YOOG5RBFUWRLX8IPVRF9:iY3Uwxxp-qa9wIsbpED3UeLkMDTGIqUqtMlNWw%3D%3D@p-riakcs.nd-cfapi.itn.ftgroup/service-instance-936c8641-2611-4371-bd71-e1ce9d0cde5b"));
        
//      assertThat(serviceInfo.getBaseUri(), is("https://p-riakcs.nd-cfapi.itn.ftgroup"));
        assertThat(serviceInfo.getBaseUri(), is("http://p-riakcs.nd-cfapi.itn.ftgroup"));
